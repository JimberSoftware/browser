<template>
  ...
  >
    ...
    <div class="video-download-row-wrapper">
      <download-list
          v-if="$store.state.showDownloadList"
          :dense="false"
    ...
    <download-list
        ...
        v-if="$store.state.showBottomDownloadList"
        :dense="true"
    ></download-list>
...
module.exports = new Promise(async (resolve, reject) => {
  ...
  resolve({
    name: "App",
    components: {
      DownloadList: httpVueLoader("js/ui/components/DownloadList.vue"),
      ...
      themenu: httpVueLoader("js/ui/components/TheMenu.vue"),
      thefileupload: httpVueLoader("js/ui/components/TheFileUpload.vue"),
    ...
    mounted() {
      ...
      physicalBrowser.addEventListeners();
    ...
    methods: {
      ...
      browserControls() {
        ...
        this.$store.state.showBrowserBar = (params.get('browsercontrols') === 'true')
      },
      onMouseClick(event) {
