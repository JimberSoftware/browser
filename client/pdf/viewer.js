...
var ProgressBar = function () {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function setWidth(viewer) {
      ...
      let viewerWidth = window.isSafari() ? viewer.offsetWidth / window.devicePixelRatio : viewer.offsetWidth;
      var scrollbarWidth = containerWidth - viewerWidth;
      if (scrollbarWidth > 0) {
...
var DEFAULT_URL = 'data:application/pdf;base64,'+decodeURIComponent(document.location.toString().split('=')[1]).replace(/\s/g, '');
;
